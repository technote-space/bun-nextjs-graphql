...
import { OnStartTaskInteractor } from './interactor';

describe('OnStartTaskInteractor', () => {
  test('指定されたIDのタスクが開始に更新される', async () => {
    // given
    ...
    const interactor = new OnStartTaskInteractor(repository);
