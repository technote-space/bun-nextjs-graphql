...
import type { DeleteTaskUseCase } from '#/usecases/task/delete/usecase';
...
@singleton()
export class DeleteTaskController<Result> extends BaseController<
  InputData,
  Result
> {
  public constructor(
    ...
    @inject(DITokens.DeleteTaskUseCase)
