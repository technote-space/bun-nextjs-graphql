...
import type { FetchTaskUseCase } from '#/usecases/task/fetch/usecase';
...
@singleton()
export class FetchTaskController<Result> extends BaseController<
  InputData,
  Result
> {
  public constructor(
    ...
    @inject(DITokens.FetchTaskUseCase)
    private readonly useCase: FetchTaskUseCase,
