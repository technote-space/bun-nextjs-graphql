...
import type { OnStartTaskUseCase } from '#/usecases/task/onStart/usecase';
...
@singleton()
export class OnStartTaskController<Result> extends BaseController<
  InputData,
  Result
> {
  public constructor(
    ...
    @inject(DITokens.OnStartTaskUseCase)
    private readonly useCase: OnStartTaskUseCase,
